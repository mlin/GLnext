...
/**
 * Hadoop/Spark CompressionOutputStream for writing out a Dataset<String> to BGZF shards. The
 * shards omit the BGZF EOF marker so that they can later be concatenated into one giant file.
 *
 * Based on GLOW's (Apache-licensed), which uses htsjdk:
...
/**
 * Hadoop/Spark compression codec wrapping BGZFOutputStream.
 *
