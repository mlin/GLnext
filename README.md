...
The single-sample `gvcf.gz` input files should be generated by DeepVariant *with read normalization* (`make_examples --normalize-reads` or `run_deepvariant --make_examples_extra_args normalize_reads=true`).
