...
# Use our Maven-based Spark installation instead of requiring SPARK_HOME
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
MAVEN_SPARK_SUBMIT="$SCRIPT_DIR/../spark-submit-maven.sh"

if ! [[ -x "$MAVEN_SPARK_SUBMIT" ]]; then
    >&2 echo "Maven-based spark-submit script not found at $MAVEN_SPARK_SUBMIT"
    exit 1
fi
